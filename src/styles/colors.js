...
export const lightPurple = '#B9C8ED';
//export const purple = '#666278';
...
export const primaryTransparent = 'rgba(19, 126, 186, 0.3)';
export const lightGrayMoreTransparent = 'rgba(226, 229, 239, 0.45)';
export const lightGrayTransparent = 'rgba(226, 229, 239, 0.85)';
export const grayTransparent = 'rgba(152, 164, 173, 0.85)';
export const darkGrayTransparent = 'rgba(34, 54, 65, 0.85)';
